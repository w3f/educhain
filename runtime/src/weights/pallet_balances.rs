...
impl<T: frame_system::Config> pallet_balances::WeightInfo for WeightInfo<T> {
    ...
    fn force_adjust_total_issuance() -> Weight {
        ...
        Weight::from_parts(7_896_000, 0).saturating_add(Weight::from_parts(0, 0))
    }

    fn burn_allow_death() -> cumulus_primitives_core::Weight {
        todo!()
    }

    fn burn_keep_alive() -> cumulus_primitives_core::Weight {
        todo!()
    }
}
